...
namespace MW\MwStarterkit\ViewHelpers\Menu;
...
class DirectoryViewHelper extends AbstractMenuViewHelper
{
    ...
    public function initializeArguments()
    {
        ...
        $this->registerArgument('levelAs', 'string', 'Name of template variable which will contain current level',
            false, null);
        ...
        $this->registerArgument('includeNotInMenu', 'boolean', 'Include pages that are marked "hide in menu"?', false,
            false);
        $this->registerArgument('includeMenuSeparator', 'boolean', 'Include pages of the type "Menu separator"?', false,
            false);
    }
