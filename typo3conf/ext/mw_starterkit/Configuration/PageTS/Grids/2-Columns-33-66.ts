tx_gridelements {
    ...
    setup {
        ...
        2-columns-33-66 {
            title = LLL:EXT:mw_starterkit/Resources/Private/Language/Backend.xlf:backend_layout.2-columns-33-66
            topLevelLayout = 1
            ...
            icon = EXT:mw_starterkit/Resources/Public/Images/Backend/2-columns-33-66.gif
        }
    }
}